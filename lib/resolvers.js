...
const resolvers = {
    ...
    // Types
    Planet: {        
        spaceCenters: (parent, args) => spaceCenters.getByCode(parent.code, args.limit ? args.limit : 5) // fetches space centers of a planet limited to int in args.limit or 5 if null        
    },   
    SpaceCenter: {
